...
- fe5fea4: unnecesary resource re-creation
...
- c642a60: add auth.blocked_user event support
...
- 47e8366: events: set crypto reward to string; SocialUser.socialMedia -> Record<string, string>
...
- 9190d99: new event 'legend_rankings.crypto_ranking_finished'
